...
use futures_util::{Stream, TryStreamExt, lock::Mutex as AsyncMutex};

use crate::{
  EntryPayload, OptionalSend,
  alias::{EntryOf, LogIdOf, SnapshotMetaOf, SnapshotOf, StoredMembershipOf, VoteOf},
  entry::RaftEntry,
  impls::leader_id_adv::LeaderId,
  storage::{
...
impl MemStateMachine {
  ...
  pub fn take_try_create_snapshot_builder_count(&self) -> u64 {
    self
      .try_create_snapshot_builder_count
